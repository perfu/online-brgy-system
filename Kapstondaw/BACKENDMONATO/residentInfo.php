        ...
        <?php if(!empty($residents)) { ?>
          <?php $no=1; foreach($residents as $row): ?>
            <tr>
              ...
              <td><?= $row['email'] ?></td>
              <td class="actions">
                <a href="#" class="edit" id="editResidents"
                ...
                data-houseNo="<?= $row['house-no'] ?>" 
                data-street="<?= $row['street'] ?>" 
                data-subdivision="<?= $row['subdivision'] ?>" 
                data-dbirth="<?= $row['date-of-birth'] ?>"
                data-pbirth="<?= $row['place-of-birth'] ?>"
                data-cstatus="<?= $row['civil-status'] ?>"
                data-occupation="<?= $row['occupation'] ?>"
                data-email="<?= $row['email'] ?>"
                data-contactNo="<?= $row['contact-no'] ?>"
                data-vstatus="<?= $row['voter-status'] ?>"
                data-identified="<?= $row['identified'] ?>"
                data-sector="<?= $row['sector'] ?>"
                data-citizenship="<?= $row['citizenship'] ?>"
                data-householdNo="<?= $row['household-no'] ?>"
                data-osy="<?= $row['osy'] ?>"
                data-pwd="<?= $row['pwd'] ?>"
                data-mfname="<?= $row['mother-firstname'] ?>"
                data-mmname="<?= $row['mother-middlename'] ?>"
                data-mlname="<?= $row['mother-lastname'] ?>"
                data-mage="<?= $row['mother-age'] ?>"
...
<div class="pangapat-layer">
  ...
  <div class="input-wrapper">
    <div class="check2">
    <input type="checkbox" id="person-with-disability1" value="PWD" name="person-with-disability">
...
<div class="parent-info">
  ...
  <div class="input-wrapper">
    ...
    <div class="address-cont">
      <input type="text" id="mother-house-no1" name="mother-house-no" placeholder="House No." required><br>
      <input type="text" id="mother-street1" name="mother-street" placeholder="Street" required><br>
      <input type="text" id="mother-subdivision1" name="mother-subdivision" placeholder="Subdivision" required>
    </div>
  </div>
  ...
  <div class="input-wrapper">
    ...
    <div class="address-cont">
      <input type="text" id="father-house-no1" name="father-house-no" placeholder="House No." required><br>
      <input type="text" id="father-street1" name="father-street" placeholder="Street" required><br>
      <input type="text" id="father-subdivision1" name="father-subdivision" placeholder="Subdivision" required>
    </div>
  </div>
...
<div class="pangapat-layer">
  ...
  <div class="input-wrapper">
    <div class="check2">
    <input type="checkbox" id="person-with-disability" value="PWD" name="person-with-disability">
    <label for="person-with-disability">Person with Disability:</label>
    </div>
  </div>
  </div>
...
<div class="parent-info">
  ...
  <div class="input-wrapper">
    <label for="mother-address">Address:</label><br>
    <div class="address-cont">
      <input type="text" id="mother-house-no" name="mother-house-no" placeholder="House No." required><br>
      <input type="text" id="mother-street" name="mother-street" placeholder="Street" required><br>
      <input type="text" id="mother-subdivision" name="mother-subdivision" placeholder="Subdivision" required>
    </div>
  </div>
  
  <div class="input-wrapper">
  <div class="checkbox-household">
    <input type="checkbox" id="mother-household-head" value="household-head" name="mhousehold-head">
  ...
  <div class="input-wrapper">
    <label for="father-address">Address:</label><br>
    <div class="address-cont">
      <input type="text" id="father-house-no" name="father-house-no" placeholder="House No." required><br>
      <input type="text" id="father-street" name="father-street" placeholder="Street" required><br>
      <input type="text" id="father-subdivision" name="father-subdivision" placeholder="Subdivision" required>
    </div>
  </div>
  
  <div class="input-wrapper">
  <div class="checkbox-household1">
    <input type="checkbox" id="father-household-head" value="household-head" name="fhousehold-head">
