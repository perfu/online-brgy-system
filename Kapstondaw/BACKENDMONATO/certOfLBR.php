            ...
            <?php $no=1; foreach($certoflbr as $row): ?>
              ...
              <td>
                <?php if($row['documentFor'] === 'self') { ?>
                  <a href="./generate/certOfLBR_generate_forself.php?id=<?= $row['id'] ?>" class="print">Print</a>
                <?php }
                elseif ($row['documentFor'] === 'children') { ?>
                  <a href="./generate/certOfLBR_generate_fortheirchild.php?id<?= $row['id'] ?>" class="print">Print</a>
                <?php } else {?>
                  <a href="./generate/certOfLBR_generate_forsingleparent.php?id=<?= $row['id'] ?>" class="print">Print</a>
                <?php } ?>
