        ...
        <div class="form-container-brgyClearance" id="printMe">
            <form action="#" class="paper" style="border:1px solid black">
                ...
                height: 133px;">
                    <img
                        class="left"
                        src="../image/barangaylogo.png"
                        alt=""
                        style="width: 118.677px;
                    height: 132.677px;
                    margin-left: 10px;
                    margin-top: 10px;">
                    ...
                    <img
                        class="right"
                        src="../image/dasmaLogoPrint.png"
                        alt=""
                        style=" width: 115.677px;
                    height: 125.677px;
                    ...
                    padding: 10px;">
                        ...
                        margin-top: 30px;">
                            ...
                            align-items: center;">FINDINGS:
                                ...
                                font-weight: 700;
                                line-height: normal;
                                margin-top: 12px;">NO CRIMINAL, CIVIL OR ADMINISTRATIVE COMPLAINT/S AS OF THIS DATE ISSUE</span></p>
                        </div>
                        ...
                        margin-top: 12px;">
                            ...
                            margin-right: 40px;">
                                ...
                                justify-content: center;
                                align-items: center;
                                margin-top: 90px;">Right Thumb Mark</span></p>
                        </div>
                        ...
                        font-style: italic;
                        font-weight: 400;
                        line-height: 30px;">(2 Months Validity after Date of Issue) Not Valid Without Official Dry Seal</p>

                        <div
                            class="watermark-cont-brgyClearance"
                            style="position: relative;
                        margin-top: -680px;
                        margin-left: 20px;">
                            <img
                                src="../image/watermarklogo.png"
                                alt=""
                                style=" position: absolute;
                            top: 0;
                            left: 0;
