                ...
                height: auto;">
                    ...
                    padding: 10px;">
                        ...
                        margin-top: 50px;">To:
                            ...
                            font-style: normal;
                            font-weight: 700;
                            line-height: normal;">FULGENCIO “JUN” C. DELA CUESTA JR.</span></p>
                        ...
                        margin-top: 50px;">This is certify that
                            <input type="text" id="name" placeholder="NAME OF APPLICANT" style="color: #000;
                            font-family: Caladea;
                            font-size: 19px;
                            font-style: normal;
                            font-weight: 400;
                        ...
                        margin-top: 50px;">This certification is being issued upon the request of above
                            mention name for the purpose/s of compliance to <input type="text" id="purpose" placeholder="PURPOSE" style=" color: #000;
                            font-family: Caladea;
                            font-size: 19px;
                            font-style: normal;
                            font-weight: 400;
