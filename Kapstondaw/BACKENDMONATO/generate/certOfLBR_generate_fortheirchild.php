        ...
        <div class="form-container"  id="printMe">
            <form action="#" class="paper">
                ...
                height: auto;">
                    ...
                    margin-top: 30px;
                    margin-left: 70px;">1.
                        <input type="text" id="nameRequest" placeholder="NAME OF REQUESTING LATE BIRTH" style="color: #000;
                        font-family: Caladea;
                        font-size: 19px;
                        font-style: normal;
                        font-weight: 700;
                        ...
                        <input type="text" id="nameFather" placeholder="FATHER’S NAME" style="color: #000;
                        font-family: Caladea;
                        font-size: 19px;
                        font-style: normal;
                        font-weight: 700;
                        ...
                        width: 200px;">
                        and
                        <input type="text" id="nameMother" placeholder="MOTHER’S NAME" style="color: #000;
                        font-family: Caladea;
                        font-size: 19px;
                        font-style: normal;
                        font-weight: 700;
                        ...
                        <input type="text" id="dob" placeholder="DATE OF BIRTH" style="color: #000;
                        font-family: Caladea;
                        font-size: 19px;
                        font-style: normal;
                        font-weight: 700;
                    ...
                    margin-left: 70px;">
                        ...
                        <input type="text" id="nameFather1" placeholder="FATHER'S NAME" style="color: #000;
                        font-family: Caladea;
                        font-size: 19px;
                        font-style: normal;
                        font-weight: 700;
                        ...
                        width: 200px;">
                        and
                        <input type="text" id="nameMother1" placeholder="MOTHER’S NAME" style="color: #000;
                        font-family: Caladea;
                        font-size: 19px;
                        font-style: normal;
                        font-weight: 700;
                        ...
                        border: none;
                        border-bottom: 1px solid black;
                        width: 200px;">, Subd., Zone IV, City of Dasmarinas, Cavite.</p>
                    ...
                    margin-left: 70px;">This certification is being issued to the request of
                        <input type="text" id="nameFather2" placeholder="FATHER'S NAME" style="color: #000;
                        font-family: Caladea;
                        font-size: 19px;
                        font-style: normal;
                        font-weight: 700;
                        ...
                        width: 200px;">
                        and
                        <input type="text" id="nameMother2" placeholder="MOTHER’S NAME" style="color: #000;
                        font-family: Caladea;
                        font-size: 19px;
                        font-style: normal;
                        font-weight: 700;
                        ...
                        border-bottom: 1px solid black;
                        width: 200px;">
                        in order to certify the birth of <input type="text" id="nameRequest3" placeholder="NAME OF REQUESTING LATE BIRTH" style="color: #000;
                        font-family: Caladea;
                        font-size: 19px;
                        font-style: normal;
                        font-weight: 700;
                        ...
                        Civil Registrar of City of Dasmarinas, Cavite.</p>
