      ...
      <form action="#" class="paper">
        ...
        <div class="lines" style="border-bottom:1px solid black"></div>
         ...
         height: auto;">
          ...
          margin-top: 30px;
          margin-left: 85px;"><span>I am here to endorse <input type="text" id="name" placeholder="NAME OF REQUESTOR" required style=" color: #000;
            font-family: Caladea;
            font-size: 20px;
            font-style: normal;
            font-weight: 400;
            ...
            bonafide residents of <input type="text" id="address" placeholder="ADDRESS" required style=" color: #000;
            font-family: Caladea;
            font-size: 20px;
            font-style: normal;
            font-weight: 400;
          ...
          margin-left: 85px;"><span>In this regard, I would like to endorse (him/her) to your office for
           </span><br><input type="text" id="purpose" placeholder="PURPOSE" required style=" color: #000;
           font-family: Caladea;
           font-size: 20px;
           font-style: normal;
           font-weight: 400;
           ...
           border-bottom: 1px solid black;
           width: 200px;">
           of (his/her) brother, <input type="text" id="name1" placeholder="NAME OF APPLICANT" style=" color: #000;
           font-family: Caladea;
           font-size: 20px;
           font-style: normal;
           font-weight: 400;
